...
df = pd.read_csv("./data/updatetrain.csv",encoding='cp1252')
df = df.drop(['sl_no'], axis=1)
df = df.apply(lambda x: x.fillna(0))
col_names = df.columns
category_col = ['ssc_b','hsc_b','hsc_s','degree_t','workex','specialisation','Communication_level','technical _skills','soft _skills','status']
...
pickle.dump(clf, open("updatemodel.pkl", "wb"))
